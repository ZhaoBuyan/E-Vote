    ...
    evaluation: [
        {
            ...
            description:
                '请根据候选人在实际工作中的表现，从反馈传达的及时性、问题改正的彻底性、跨部门协作的效率等维度进行评价。您的投票将作为年度评优的重要参考。',
    ...
    satisfaction: [
        {
            title: '「{topic}」满意度调查',
            description:
                '为了持续改进工作质量和服务水平，诚邀您参与本次满意度测评。您的反馈对我们至关重要，将直接影响后续优化方向。',
    ...
    selection: [
        {
            title: '「{topic}」评选活动',
            description:
                '请为您心目中的最佳选项投上宝贵一票。每人限投一次，请根据实际表现慎重选择。',
            options: ['候选人 A', '候选人 B', '候选人 C', '候选人 D']
        }
    ],
    general: [
        {
            title: '关于「{topic}」的投票',
            description:
                '请根据您的实际情况和偏好，选择最符合您观点的选项。本次投票为匿名，结果将用于后续决策参考。',
...
【场景识别规则】
- 如果主题包含"评选""优秀""最佳""候选""提名"等关键词 → 生成"评选型"投票
- 如果主题包含"满意""体验""服务""质量"等关键词 → 生成"满意度调查型"投票
- 如果主题包含"年会""活动""团建""节目"等关键词 → 生成"活动征集型"投票
- 其他情况 → 生成"通用型"投票
...
1. 选项数量：4-6个
2. 每个选项长度：2-8个字，简洁明确
3. 选项之间互不重叠，且都与主题高度相关
4. 不要使用"其他""以上都是"等笼统选项
...
{
    "title": "2024年度优秀员工评选",
    "description": "请从以下候选人中选出你认为最符合年度优秀员工标准的同事，每人限投一票。",
    "options": ["候选人A", "候选人B", "候选人C", "候选人D"]
}
...
{
    "title": "公司食堂满意度调查",
    "description": "为了持续提升食堂服务质量，诚邀您参与本次满意度测评，您的反馈对我们非常重要。",
...
{
    "title": "2024年会节目征集投票",
    "description": "请选出您最想看到的年会节目类型，得票最高的节目将优先安排。",
    "options": ["唱歌", "舞蹈", "小品", "魔术", "脱口秀", "乐器演奏"]
}

【重要规则】
- 如果用户已经提供了部分内容（标题、说明或选项），请在其基础上优化完善，不要完全推翻
- 如果用户提供了选项，你必须原样保留这些选项，只优化标题和说明
- 只返回 JSON，不要有任何额外内容`
